...
public class CheckContentWriterInterceptor implements HandlerInterceptor {
	private UserBean loginUserBean;
	private BoardService boardService;

	public CheckContentWriterInterceptor(UserBean loginUserBean, BoardService boardService) {
